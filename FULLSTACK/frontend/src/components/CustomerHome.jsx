   ...
   return (
      ...
      >
         ...
         <div style={categoriesStyle}>
            <Link
               to="/customer/product?category=Jeans"
            ...
            <Link
               to="/customer/product?category=Cardigan"
               style={{ textDecoration: 'none', color: 'inherit' }}
            >
               <div style={categoryCardStyle}>
                  <div style={{ position: 'relative' }}>
            ...
            <Link
               to="/customer/product?category=Baju"
               style={{ textDecoration: 'none', color: 'inherit' }}
            >
               <div style={categoryCardStyle}>
                  <div style={{ position: 'relative' }}>
         ...
         <div style={aboutStyle}>
            ...
            <p>
               {' '}
               Welcome to Snaggle, website paling hits buat cari pakaian-pakaian
               kece dan super catchy yang cocok banget buat kamu! Di sini, kamu
               bisa temukan berbagai kategori, mulai dari fashion stylish sampai
               outfit-outfit unik lainnya. Pokoknya, belanja di Snaggle bikin
               pengalaman makin seru dan pastinya gampang banget. Yuk, let's
               snag something cool!{' '}
            </p>
         </div>
         <footer
